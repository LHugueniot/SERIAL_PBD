...
void Camera::yawCamera(float yawAngle){
    m_yaw -= yawAngle;
...
void Camera::pitchCamera(float pitchAngle){
...
void Camera::moveCamera(Camera::Actions action){
    switch (action){
        case Camera::ORBIT_LEFT:
            yawCamera(m_rotationSpeed);
            break;
        case Camera::ORBIT_RIGHT:
            yawCamera(-m_rotationSpeed);
            break;
        case Camera::ORBIT_UP:
            pitchCamera(-m_rotationSpeed);
            break;
